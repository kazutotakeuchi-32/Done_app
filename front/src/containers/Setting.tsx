...
const Image =({image}:propTypes)=>{
  return (
    <img src={image} style={{width:"300px",height:"300px",borderRadius:"200px",marginTop:"20px"}} alt="プロフィール画像"/>
  )
}
      ...
      <Grid item sm={12} xs={12} >
        ...
        <Grid  item sm={6}  xs={12} container justify={"center"} >
            <div className="">
              ...
              {
                 values.image !="" &&
                <Fab color="primary" size="small" component="span" onClick={()=>{
                    setFieldValue("image","")
                    setImageUrl("")
                   }}>
                    <CloseIcon />
